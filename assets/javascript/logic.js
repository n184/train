...
dataRef.ref().on("child_added", function(childSnapshot) {
    ...
    var tableRow = $("<tr>");
    tableRow.append("<td>" + childSnapshot.val().name + "</td><td>" + childSnapshot.val().destination + "</td><td>" + childSnapshot.val().frequency + "</td><td>" + nextTrain + "</td><td>" + tMinutesTillTrain + "</td>");
